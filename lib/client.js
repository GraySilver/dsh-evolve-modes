window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function modeIcon(mode) {
			return mode === "normal" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconCheckOutline14, {}) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconThinkOutline14, {});
		}
		function TaskModeControl({ getMode, setMode, t }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Menu, {
				...
				onSelect: (id) => {
					...
					setBusy(true);
					setError(void 0);
					setMode(id).then(() => setCurrent(id)).catch((reason) => {
				...
				anchor: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
					...
					children: [
						modeIcon(selected.id),
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: t(selected.key) }),
